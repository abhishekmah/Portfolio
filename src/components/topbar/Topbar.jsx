    ...
    <div className={"topbar " + (menuOpen && "active")}>
      <div className="wrapper">
        ...
        <div className="right">
          ...
          <div className="itemContainer1" id="lastDiv"><a href="https://drive.google.com/file/d/1XMnQ9p6Jgj3BIITQDGvPHHIK9TmhgE5L/view?usp=sharing" target="blank" id="last">RESUME <FaDownload className="icon1"/></a></div>
